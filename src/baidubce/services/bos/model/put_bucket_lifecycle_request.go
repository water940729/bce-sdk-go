...
// put_bucket_lifecycle_request.go - the put bucket lifecycle request definition
...
func (req *PutBucketLifecycleRequest) BuildHttpRequest() *http.Request {
    ...
    case *BucketLifecycleInOut:
        ...
        if err != nil {
            req.SetClientError(bce.NewBceClientError("lifecycle json encode fail: " + err.Error()))
            return nil
        }
